  ...
  collision: {
    detect: {
      rectRect: (rectA, rectB) => {
        const formula = rectA.x < rectB.x + rectB.width && rectA.x + rectA.width > rectB.x && rectA.y < rectB.y + rectB.height && rectA.height + rectA.y > rectB.y
      ...
      circleRect: function(circle, rect) {
        const formula = circle.x < rect.x + rect.width && circle.x + circle.radius > rect.x && circle.y < rect.y + rect.height && circle.radius + circle.y > rect.y
